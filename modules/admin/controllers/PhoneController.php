...
use app\models\PhoneInformationSearch;
...
public function behaviors()
    ...
    {
        $searchModel = new PhoneInformationSearch();
    ...
    public function actionViewpage(){
        ...
        $reminderInfo = PhoneInformation::getUserPhone($userId, 10, $page);
        
        return $this->renderPartial('../widgets/phone', ['phones' => $reminderInfo, 'currentPage' => $page]);
    }
    public function actionMarkcomplete(){
        $id = $_REQUEST['id'];
        $reminder = PhoneInformation::findOne($id);
    ...
    {
        if (($model = PhoneInformation::findOne($id)) !== null) {
            return $model;
        } else {
