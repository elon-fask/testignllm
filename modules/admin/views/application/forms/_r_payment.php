...
<div class="container-payment">
    <div class="row">
        <ul class="list-inline" style="margin:10px 15px">
            <li class="col-xs-2">
                <label class="control-label"><input type="checkbox" name="W_PAYMENT_CC_VISA" id="W_PAYMENT_CC_VISA"/><i class="fa fa-2x fa-cc-visa"></i></label>
            </li>

            <li class="col-xs-2">
                <label class="control-label"><input type="checkbox" name="W_PAYMENT_CC_MASTERCARD" id="W_PAYMENT_CC_MASTERCARD"/><i class="fa fa-2x fa-cc-mastercard"></i></label>
            </li>

            <li class="col-xs-2">
                <label class="control-label"><input type="checkbox" name="W_PAYMENT_CC_AMEX" id="W_PAYMENT_CC_AMEX"/><i class="fa fa-2x fa-cc-amex"></i></label>
            </li>
