...
<?php echo $this->render('forms/_w_civil_state', []) ?>
...
<div class="row row-fees">
    ...
    <div class="col-xs-6">
        <?php echo $this->render('forms/_w_written_exams', ['formName'=>'', 'dynamicFormDetails' => null]) ?>

        <?php echo $this->render('forms/_w_other_fees', ['formName'=>'', 'dynamicFormDetails' => null]) ?>
    </div>

    <div class="col-xs-6">
        <?php echo $this->render('forms/_w_fees', ['formName'=>'', 'dynamicFormDetails' => null]) ?>
    </div>

</div>


<?php echo $this->render('forms/_w_site', ['formName'=>'', 'dynamicFormDetails' => null]) ?>


<?php echo $this->render('forms/_w_payment', ['formName'=>'', 'dynamicFormDetails' => null]) ?>
