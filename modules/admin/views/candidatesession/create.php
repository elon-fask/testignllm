...
$this->title = 'Create Candidate Session';
...
<div class="candidate-session-update">
    ...
    <form action="/admin/candidatesession/create?i=<?= $testSessionId ?>" method="POST">
    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <select name="applicationTypeId" class="form-control required" required>
                    <option value="">Please Select</option>
                    <?php foreach ($appTypes as $appType) { ?>
                    <option value="<?= $appType->id ?>"><?= $appType->name . ' - ' . $appType->price ?></option>
                    <?php } ?>
                </select>
