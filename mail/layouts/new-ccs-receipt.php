...
$headerImgUrl = Url::base(true) . '/images/site/ccs/ccs-receipt-logo.png'
?>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="720" id="templateHeader">
                        <tr>
                            <td class="headerContent">
                                <a href="http://www.californiacraneschool.com/"><img src="<?= $headerImgUrl ?>" style="max-width:720px;" id="headerImage" /></a>
                            </td>
                        </tr>
                    </table>
                </td>
